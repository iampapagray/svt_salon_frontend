    ...
    <form @submit="onSubmit" class="space-y-4">
        ...
        <FormField v-slot="{ componentField }" name="description">
            <FormItem>
                ...
                <FormControl>
                    <Textarea placeholder="Describe the service you require" v-bind="componentField" />
                </FormControl>
                <FormMessage />
            </FormItem>
        </FormField>
            ...
            <FormItem class="flex flex-col">
                ...
                <Popover>
                    ...
                    <PopoverContent class="flex w-auto flex-col space-y-2 p-2">
                        <Select @update:model-value="(val) => handleInput(addDays(new Date(), parseInt(val)))">
                            <SelectTrigger>
                ...
                <FormItem>
                    ...
                    <Select v-bind="componentField">
                        ...
                        <SelectContent class="bg-gray-300">
                            <SelectGroup>
                                <SelectItem v-for="(option, index) in store.timeOptions" :key="index" :value="option">
                                    {{ option }}
                                </SelectItem>
                            </SelectGroup>
                        </SelectContent>
